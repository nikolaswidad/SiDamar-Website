...
@section('container')
    ...
    @endif
    <form action="/dashboard/arsipFilm/" method="post" class="mt-8 mb-8 font-montserrat">
        @csrf
        @method('POST')
        <div class="max-w-3xl xl:max-w-7xl">
            <div class="grid grid-cols-2 gap-3">
                ...
                <div>
                    <label for="no_telepon" class="block text-gray-700 text-lg font-bold mb-2">Nomor Telepon</label>
                    <input type="text" name="no_telepon" class="h-11 block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline mb-3" placeholder="Nomor yang bisa dihubungi" value="{{ old('no_telepon') }}">
            ...
            <div>
                <input type="checkbox" id="pernyataan" name="pernyataan" value="False" class="my-3">
