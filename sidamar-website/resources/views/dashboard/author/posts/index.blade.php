...
@section('container')
  <div class="max-w-full font-montserrat">
    ...
    <a href="{{ route('posts.create') }}"><button type="button" class="p-3 bg-primary rounded-lg text-white font-semibold hover:bg-red-600 mb-6">+ Tambah Post</button></a>
       ...
       <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
         <thead class="text-sm text-gray-700 bg-gray-50 border-b dark:bg-gray-700 dark:text-gray-400">
            <tr>
             ...
             <th scope="col" class="text-lg text-gray-900 px-6 py-4 text-left">Title</th>
             <th scope="col" class="text-lg text-gray-900 px-6 py-4 text-left">Author</th>
             <th scope="col" class="text-lg text-gray-900 px-6 py-4 text-left">Category</th>
             <th scope="col" class="text-lg text-gray-900 px-6 py-4 text-left">Image</th>
         <th scope="col" class="text-lg text-gray-900 px-6 py-4 text-left">Edit</th>
         <th scope="col" class="text-lg text-gray-900 px-6 py-4 text-left">Delete</th>
            </tr>
          </thead>
