  ...
  <!-- Text Header -->
	...
	{{-- <div class="mx-14 px-20">
		...
		<div class="container mx-auto flex flex-wrap py-6">
			<div class="px-3 w-2/3 mb-4">
				...
				@endif
				<label for="search" class="mb-2 text-base font-medium text-gray-900 sr-only dark:text-white">Search</label>
				<div class="relative w-full">
					<div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
						<svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
					</div>
					<input type="text" id="search" name="search" class="w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 mr-96" placeholder="Search..." value="{{ request('search') }}" required>
	...
	<!-- Pagination -->
		<div class="flex items-center pt-8">
			<a href="{{$data->previousPageUrl()}}" class="h-10 w-10 bg-red-800 hover:bg-red-600 font-semibold text-white text-sm flex items-center justify-center"><</a>
			...
			@endfor
			<!-- a Tag for next page -->
			<a href="{{$data->nextPageUrl()}}" class="h-10 w-10 bg-red-800 hover:bg-red-600 font-semibold text-white text-sm flex items-center justify-center">></a>
		</div>
