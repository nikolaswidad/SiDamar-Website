...
class PresentMemberController extends Controller
{
    ...
    switch ($type) {
        ...
        case 'Sakit':
            return [
                'color' => 'text-white bg-blue-500 focus:outline-none focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800',
        ...
        default:
            return [
                'color' => 'bg-white border border-gray-300 focus:outline-none focus:ring-4 font-medium rounded- text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700',
                'hover' => '',
                'fill' => '',
            ];
        }
