...
@section('container')
    ...
    <p class="px-10 text-primary">Periksa kembali data yang telah dimasukkan, apabila terdapat kesalahan input data, silahkan hubungi 0895359747200</p>
    {{-- Form Pengisian Arsip Film versi 2 responsive--}}
    <form action="/"class="py-2 px-10 w-full mb-20">
        @csrf
        {{-- make in 2 coloum --}}
        <div>
            ...
            <div class="py-5">
                {{-- href to homepage --}}
                <a href="{{ url('/') }}" class="bg-gray-500 hover:bg-gray-600 px-4 py-3 rounded text-white text-lg font-bold w-full my-3">Kembali</a>
