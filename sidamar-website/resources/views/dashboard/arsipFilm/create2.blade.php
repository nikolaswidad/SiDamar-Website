...
@section('container')
    ...
    <div class="px-10">
        <img src="/arsipFilm1/arsip_film.jpg" alt="arsipFilm" class="object-center object-cover shadow-lg sm:w-full sm:object-cover sm:h-52 sm:object-center md:text-6xl">
    </div>
