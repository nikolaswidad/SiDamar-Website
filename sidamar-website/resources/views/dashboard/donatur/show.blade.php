...
@section('container')
    ...
    @endif
    <div class="relative mx-auto max-w-screen-xl px-4 py-8 mr-9">
            ...
            <form action="#" method="POST">
              <div class="overflow-hidden shadow sm:rounded-md">
                <div class="bg-white px-4 py-5 sm:p-6">
                  ...
                  <p class="text-xs text-center mb-5">Dipesan pada: {{ $donatur->created_at }}</p>
                ...
                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                  <a href="/dashboard/donatur/"type="button" class="mt-2 text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-4 py-2 text-center mr-1 inline ">Back</a>
                </div>
              </div>
            </form>
          </div>
