               ...
               <div class="flex-1 px-3 bg-white divide-y space-y-1">
                  ...
                  <div>
                     ...
                     <div class="space-y-2 pt-2">
                        ...
                        <a href="/dashboard/donation/" class="sidebar-a group">
                           <svg class="flex-shrink sidebar-svg" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="/dashboard/customer/" class="sidebar-a group">
                           <svg class="flex-shrink sidebar-svg" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      <ul class="space-y-2 font-medium pt-4 ">
         <li>
            <a href="/logout" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 border-3 border-gray-100">
               <svg fill="none" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" stroke="red" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
               <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75"></path>
               </svg>
               <span class="flex-1 ml-3 whitespace-nowrap text-red-700">Log Out</span>
            </a>
         </li>
