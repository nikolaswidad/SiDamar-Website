...
@section('container')
    ...
    <div class="h-72 overflow-hidden px-10">
        <img src="/about1/1.jpg" alt="arsipFilm" class="shadow-lg sm:w-full sm:object-cover sm:h-52 lg:object-center lg:h-72">
    </div>
    ...
    <div class="mx-10 my-10 pb-5 boder-2 border-slate-400 shadow-lg rounded-lg">
